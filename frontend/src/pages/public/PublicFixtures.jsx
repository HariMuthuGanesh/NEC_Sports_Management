...
export default function PublicFixtures() {
  ...
  const columns = [
    ...
    { key: "teams", label: "Match Teams", render: (_, row) => <span>{row.teamA} ({row.deptA}) vs {row.teamB} ({row.deptB})</span> },
  ...
  return (
    <div className="nec-portal-page">
      <div className="nec-page-header">
        <h2 className="nec-page-title">Tournament Fixtures & Schedule</h2>
